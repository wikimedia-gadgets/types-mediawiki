declare global {
    namespace mw {
        ...
        class ForeignUpload extends Upload {
             ...
             * @param {Partial<Api.Options>} [apiconfig] Passed to the constructor of mw.ForeignApi or mw.Api, as needed.
             */
            constructor(target: string, apiconfig?: Partial<ForeignApi.Options>);
            constructor(apiconfig?: Partial<Api.Options>);
        }
    }
}
