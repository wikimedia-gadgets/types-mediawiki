...
type TitleLike = mw.Title | string;
...
declare global {
    namespace mw {
        ...
        class Api {
             ...
             */
            assertCurrentUser(query: ApiParams): {
                assert: "anon" | "user";
                assertUser?: string;
            };
             ...
             * @return {ApiUploadParams} return.finishUpload.data Additional data for the upload.
             * @return {JQuery.Promise} return.finishUpload.return API promise for the final upload
             * @return {ApiResponse} return.finishUpload.return.data API return value for the final upload
            ...
            edit(
                ...
                transform: (data: {
                    timestamp: string;
                    content: string;
                }) => string | ApiEditPageParams | JQuery.Promise<string | ApiEditPageParams>
            ): JQuery.Promise<any>;
             ...
             * @return {JQuery.Promise<false | Title[]>} List of category titles or false
             ...
             * @return {JQuery.Promise} return.finishUpload.return API promise for the final upload
             * @return {Object} return.finishUpload.return.data API return value for the final
             ...
             * @param {ApiResponse} result API result
